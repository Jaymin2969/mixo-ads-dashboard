...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f172a] transition-colors duration-300">
      {/* Header */}
      <header className="bg-white dark:bg-[#1e293b] border-b border-gray-200 dark:border-[#334155] transition-colors duration-300">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {campaigns.length === 0 ? (
          <div className="bg-white dark:bg-[#1e293b] rounded-lg shadow-sm border border-gray-200 dark:border-[#334155] p-12 text-center animate-fade-in transition-colors duration-300">
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-[#1e293b] border-t border-gray-200 dark:border-[#334155] mt-12 transition-colors duration-300">
